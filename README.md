...
byte of your financial data anywhere. There is no server, no need for internet, no account, no telemetry, and no analytics. Everything lives in one SQLCipher-encrypted
SQLite file on your own disk.

The trade-off is deliberate: no bank sync, no integrations, no automations —
that's the price of keeping your data on your own machine, and it buys
security and simplicity in return.
...
of the implementation, tests, and docs were generated by Claude. 
